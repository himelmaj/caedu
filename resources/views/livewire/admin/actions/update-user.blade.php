    ...
    <x-dialog-modal wire:model="modal">
            ...
            <x-slot name="content">
                ...
                <form wire:submit="save" class="flex flex-col gap-2">
                    ...
                    <x-input id="name" class="block w-full" type="text" wire:model.blur='form.name' required
                        placeholder="Name" />
                    <x-input-error for="form.name" class="mt-2" />
                    <x-input id="email" class="block w-full" type="email" wire:model.blur='form.email' required
                        placeholder="Email" />
                    <x-input-error for="form.email" class="mt-2" />
                    <x-input id="password" class="block w-full" type="password" wire:model.blur="form.password" required
                        placeholder="Password" />
                    <x-input-error for="form.password" class="mt-2" />
                    <x-input id="password_confirmation" class="block w-full" type="password"
                        wire:model.blur="form.password_confirmation" required placeholder="Confirm Password" />
